...
class Attribute: UniqueAttribute
{
	...
	For resource names:
		...
		- unregFolders - Specifies that the attribute can hold only a resource name of unregistered folder (without a meta-file). This is usual in properties of editing tools/plugins which are not a part of game data
