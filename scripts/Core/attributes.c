...
class UIWidgets
{
	...
	*/
	...
	and max value separated by space. There can be also optional "sortAlphabet"
	param that must be placed after min, max and step values.	Enums may contain selectable values.
