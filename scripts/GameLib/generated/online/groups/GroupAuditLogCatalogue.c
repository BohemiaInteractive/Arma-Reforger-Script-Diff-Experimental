...
sealed class GroupAuditLogCatalogue
{
	private void GroupAuditLogCatalogue();
	private void ~GroupAuditLogCatalogue();
	...
	Pages are indexed from 0. Int is cast into uint32.
	...
	*/
	proto external void SetFilters(GroupAuditLogCatalogueFilters pFilters);
	/*!
	...
	*/
	proto external GroupAuditLogCatalogueFilters GetFilters();
	/*!
	...
	*/
	proto external void AppendOrderBy(EBackendCatalogueOrderDir orderDir, EGroupAuditLogCatalogueOrderBy orderBy);
	...
	Offset 0 represent first item. Int is cast into uint32.
	...
	*/
	...
	//! Get page content
	proto external int GetPageItems(out notnull array<GroupAuditLogEvent> outEvents);
}
