...
sealed class GroupMemberCatalogue
{
	...
	*/
	proto external void SetFilters(GroupMemberCatalogueFilters pFilters);
	/*!
	...
	*/
	proto external GroupMemberCatalogueFilters GetFilters();
	/*!
	...
	*/
	proto external void AppendOrderBy(EBackendCatalogueOrderDir orderDir, EGroupMemberCatalogueOrderBy orderBy);
