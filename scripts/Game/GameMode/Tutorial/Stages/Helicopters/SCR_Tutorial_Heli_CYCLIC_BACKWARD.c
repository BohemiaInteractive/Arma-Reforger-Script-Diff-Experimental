...
class SCR_Tutorial_Heli_CYCLIC_BACKWARDClass: SCR_BaseTutorialStageClass
{
};

//------------------------------------------------------------------------------------------------
class SCR_Tutorial_Heli_CYCLIC_BACKWARD : SCR_BaseTutorialStage
{
	...
	{		
		...
		PlayNarrativeCharacterStage("HELICOPTER_Copilot", 7);
	}
