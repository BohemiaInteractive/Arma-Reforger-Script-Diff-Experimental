...
class SCR_Tutorial_Heli_CYCLIC_ANTITORQUE_LEFTClass: SCR_BaseTutorialStageClass
{
};

//------------------------------------------------------------------------------------------------
class SCR_Tutorial_Heli_CYCLIC_ANTITORQUE_LEFT : SCR_BaseTutorialStage
{
	...
	{		
		...
		PlayNarrativeCharacterStage("HELICOPTER_Copilot", 5);
	}
