...
class SCR_Tutorial_ShootingRange_TAKE_MAGAZINE_GAMEPADClass: SCR_BaseTutorialStageClass
{
};

//------------------------------------------------------------------------------------------------
class SCR_Tutorial_ShootingRange_TAKE_MAGAZINE_GAMEPAD : SCR_BaseTutorialStage
{
	...
	//------------------------------------------------------------------------------------------------
	protected void HighlightWeapon()
	{	
		if (m_wHighlight)
	...
	//------------------------------------------------------------------------------------------------
	protected void HighlightMagazine()
	{
		if (m_wHighlight)
			m_wHighlight.RemoveFromHierarchy();
