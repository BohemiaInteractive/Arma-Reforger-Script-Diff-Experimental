...
void PersistenceWhenAvailableTaskDelegate(Managed instance, PersistenceDeferredDeserializeTask task, bool expired, Managed context = null); typedef func PersistenceWhenAvailableTaskDelegate;
