...
class SCR_ScenarioFrameworkActionDecreaseLogicCounter : SCR_ScenarioFrameworkActionBase
{
	[Attribute(desc: "Logic Counter to decrease (Optional if this action is attached on Counter)")]
