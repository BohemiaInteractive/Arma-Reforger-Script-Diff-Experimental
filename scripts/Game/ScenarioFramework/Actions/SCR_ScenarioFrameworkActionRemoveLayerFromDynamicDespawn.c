...
class SCR_ScenarioFrameworkActionRemoveLayerFromDynamicDespawn : SCR_ScenarioFrameworkActionBase
{
	[Attribute(desc: "Target Layer to remove")]
	...
	override void OnActivate(IEntity object)
	{
		...
		parentArea.RemoveLayerSpecificDynamicDespawn(layer, m_bStaySpawned);
	}
}