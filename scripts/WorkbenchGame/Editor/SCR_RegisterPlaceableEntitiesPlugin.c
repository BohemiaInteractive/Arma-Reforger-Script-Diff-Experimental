#ifdef WORKBENCH
[WorkbenchPluginAttribute(name: "Register Placeable Entities...", category: SCR_PluginCategory.EDITOR, wbModules: { "ResourceManager" })]
class SCR_RegisterPlaceableEntitiesPlugin : WorkbenchPlugin
{
